...
export declare class NgxPaypalComponent implements OnChanges, OnDestroy, AfterViewInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NgxPaypalComponent, "ngx-paypal", never, { "registerScript": "registerScript"; "config": "config"; }, { "scriptLoaded": "scriptLoaded"; }, never, never, false>;
}
